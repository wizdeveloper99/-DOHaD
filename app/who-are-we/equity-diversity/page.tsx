...
import { Users, ShieldCheck, Download, ArrowRight } from "lucide-react"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="group p-6 bg-card border border-border rounded-2xl flex flex-col hover:shadow-md hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="font-bold text-lg mb-2 text-foreground group-hover:text-primary transition-colors">Inclusivity</h3>
